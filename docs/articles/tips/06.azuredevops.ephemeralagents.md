...
- Que vous pouvez sécuriser vos déploiement logicielle même avec des solutions cloud,
- Que vous pouvez mettre en place des solutions de build et de déploiement sobre en contenurisant les framework et services dont vous avez besoin,
- Que vous pouvez facilement l'intégré avec **Azure DevOps**.

J'espère vous avoir convaincu et si cela vous intresse, je vous invite à vous approprier ce que j'ai pu produire pour cet article :
