...
!!! note "Mise à jour du 05/02/2022"
    ...
    - Lors de la création du **pool**, il faut indiquer que l'on ne veux pas créer d'IP public [cf. documentation Microsoft](https://docs.microsoft.com/en-us/azure/batch/batch-pool-no-public-ip-address),
