...
!!! note
    Pour en savoir plus, je vous invite à consulter la documentation de Microsoft : [ici](https://docs.microsoft.com/fr-fr/azure/azure-app-configuration/overview?WT.mc_id=AZ-MVP-5004832) 
...
[A suivre...](02.gitops.AzureAppConfiguration.md)

## Références

- [Microsoft : Azure App Configuration](https://docs.microsoft.com/en-us/azure/azure-app-configuration/?WT.mc_id=AZ-MVP-5004832)
- [Azure App Configuration refresh on demand](https://www.bustroker.com/notes/azure-app-configuration-refresh-on-demand/?WT.mc_id=AZ-MVP-5004832)
